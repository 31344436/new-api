...
export const modelColorMap = {
  // OpenAI gpt-5.4
  'gpt-5.4':        'rgb(30,144,255)',  // 道奇蓝
  'gpt-5.4-mini':   'rgb(0,191,255)',   // 深天蓝
  'gpt-5.3-codex':  'rgb(0,90,200)',    // 深蓝
  // Claude 4.6
  'claude-sonnet-4-6':      'rgb(253,135,93)',  // 橙色
  'claude-opus-4-6':        'rgb(255,100,31)',  // 深橙
  'claude-opus-4-6-max':    'rgb(220,60,0)',
  'claude-opus-4-6-high':   'rgb(220,80,20)',
  'claude-opus-4-6-medium': 'rgb(230,110,50)',
  'claude-opus-4-6-low':    'rgb(240,140,80)',
  // Gemini 3.1
  'gemini-3.1-pro-preview':             'rgb(66,133,244)',  // Google蓝
  'gemini-3.1-pro-preview-customtools': 'rgb(30,100,210)',
  'gemini-3.1-flash-lite-preview':      'rgb(52,168,83)',   // Google绿
  'gemini-3.1-flash-image-preview':     'rgb(20,140,60)',
  'nano-banana-pro-preview':            'rgb(251,188,4)',   // Google黄
};
